...
| TerraMind LULC | 0.5866 mIoU | 0.3553 mIoU (5-class, ESA WorldCover + DOITT labels) | 6 NYC AOIs, S2L2A+S1RTC+DEM 4 timesteps, ESA WorldCover labels | yes (cpu fp32, ~168M params multi-modal) | 6.12 J (estimated, 510 ms) |
