...
| TerraMind Buildings | 0.5511 mIoU | 0.3288 mIoU | 6 NYC AOIs, S2L2A+S1RTC+DEM 4 timesteps, DOITT labels | yes (cpu fp32, ~168M params multi-modal) | 6.13 J (estimated, 511 ms) |
